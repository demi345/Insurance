...
class Major():
    ...
    def add_course(self , course):
        ...
        if required_courses == 'R':
            self.required_courses.add(course)
        elif elective_courses == 'E':
            self.elective_courses.add(course)
        else:
            print("Course type is incorrect for course" %course)
        return None

def main():
    """a main() routine to run the whole thing"""
    students_path ='C:\Users\demis\OneDrive\Desktop\students.txt'
    repo = Repository(students_path)

    instructors_path = 'C:\Users\demis\OneDrive\Desktop\instructors.txt'
    repo = Repository(instructors_path)
    
    grades_path = 'C:\Users\demis\OneDrive\Desktop\grades.txt'
    repo = Repository(grades_path)

    majors_path = 'C:\Users\demis\OneDrive\Desktop\majors.txt'
    repo = Repository(majors_path)
